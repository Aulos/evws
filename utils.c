...
static void 
md5_update( unsigned long *state, unsigned char * buffer, 
...
void 
md5( const unsigned char *input, size_t ilen, unsigned char *output)
{
	...
	memcpy(state, state_init, sizeof(state_init)); 
